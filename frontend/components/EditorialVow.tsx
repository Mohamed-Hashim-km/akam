  ...
  return (
    <section className="relative w-full bg-white py-16 sm:py-20 lg:py-28 font-poppins overflow-hidden">
      <div className="container px-4 mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-32 items-stretch mx-auto">

          {/* Left Side Text Content */}
          <div className="lg:col-span-6 flex flex-col md:py-10 justify-center">
          ...
          <div className="lg:col-span-6 relative w-full min-h-[280px] sm:min-h-[340px] h-full rounded-3xl overflow-hidden bg-gray-100 shadow-xs">
            <Image
              src={imageSrc}
              alt={imageAlt}
              fill
