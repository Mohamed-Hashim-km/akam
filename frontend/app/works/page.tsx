...
function WorksCatalogContent() {
  ...
  const [selectedCategory, setSelectedCategory] = useState<string>(() => {
    if (typeof window !== "undefined") {
      const saved = sessionStorage.getItem("akam_works_category") || sessionStorage.getItem("akam_stories_category");
  ...
  const handleCategoryChange = (categoryName: string) => {
    ...
    if (typeof window !== "undefined") {
      sessionStorage.setItem("akam_works_category", categoryName);
    }
  };
          ...
          <div className="container px-4 mx-auto relative z-10">
            <div className="max-w-3xl">
              ...
              <p className="text-base sm:text-lg text-gray-300 font-normal leading-relaxed">
                Discover curated articles, stories, essays, paintings, and digital creative works published on the AKAM platform.
              </p>
            </div>
            ...
            <div className="mt-8 pt-8 border-t border-gray-800/80 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
              <div className="relative max-w-md w-full">
                ...
                <input
                  type="text"
                  placeholder="Search works, articles, paintings, author or keyword..."
              ...
              <div className="text-xs font-semibold text-gray-400 flex items-center gap-2">
                ...
                <span>Showing <strong className="text-white">{totalItems}</strong> published works</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <div className="container px-4 mx-auto mt-10">
          ...
          {loading ? (
            <div className="py-24 flex flex-col justify-center items-center">
              ...
              <p className="text-xs font-semibold text-gray-600">Loading published works...</p>
            </div>
          ) : stories.length === 0 ? (
            <div className="bg-white border border-gray-200 rounded-[32px] p-12 text-center max-w-lg mx-auto shadow-xs my-8">
              ...
              <p className="text-xs text-gray-500 leading-relaxed mb-6">
                There are no published works matching your current category filter or search terms.
              </p>
              <Button
                variant="secondary"
                size="sm"
